...
describe('ApiFetcher', () => {
  ...
  describe('fetch', () => {
    it('returns QuotaSnapshot from JSON response', async () => {
      ...
      expect(snapshot.rolling.periodStartSeconds).toBeTypeOf('number');
      expect(snapshot.rolling.periodEndSeconds).toBeTypeOf('number');
      expect(snapshot.rolling.periodEndSeconds).toBeGreaterThanOrEqual(snapshot.rolling.periodStartSeconds);
      ...
      expect(snapshot.weekly.periodStartSeconds).toBeTypeOf('number');
      expect(snapshot.weekly.periodEndSeconds).toBeTypeOf('number');
      expect(snapshot.weekly.periodEndSeconds).toBeGreaterThanOrEqual(snapshot.weekly.periodStartSeconds);
      ...
      expect(snapshot.monthly.periodStartSeconds).toBeTypeOf('number');
      expect(snapshot.monthly.periodEndSeconds).toBeTypeOf('number');
      expect(snapshot.monthly.periodEndSeconds).toBeGreaterThanOrEqual(snapshot.monthly.periodStartSeconds);
    });
